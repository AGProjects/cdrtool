...
generated by SIP Proxies, VoIP gateways or other network access equipment
that generate usage information using RADIUS protocol.
...
up to tens of millions of CDRs per month.
...
- Billing party
- Call duration
- SIP status or ISDN Q931 release cause
- Destination ID
- Rating
