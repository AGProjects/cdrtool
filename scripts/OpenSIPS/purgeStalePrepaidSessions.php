    ...
    function removeStaleSessions() {
        ...
        while ($this->db->next_record()) {
            ...
            if (count($active_sessions)) {
                ...
                if ($account_expired) {
                    $query=sprintf("update prepaid set active_sessions = '%s', session_counter  = '%s' where account  = '%s'",
        ...
        printf ("%d prepaid accounts parsed, %d sessions were stale and %d account were updated\n", $j, $expired, $removed);
    }
}
