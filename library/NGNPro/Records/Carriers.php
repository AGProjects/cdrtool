...
END;
        ...
        print "<div class='input-prepend'><span class='add-on'>Name</span><input type=text size=20 name=name></div>";
    ...
    function addRecord($dictionary = array())
    {
        ...
        $function = array(
            'commit'   => array(
                ...
                'logs'       => array(
                    'success' => sprintf('Carrier %s has been added', $name)
                )
            )
        );
    ...
    function deleteRecord($dictionary = array())
    {
        ...
        $function = array(
            'commit'   => array(
                ...
                'logs'       => array(
                    'success' => sprintf('Carrier %d has been deleted', $id)
                )
            )
        );
    ...
    function showSeachFormCustom()
    {
        printf(
            ...
            <input type=text size=10 name=id_filter value='%s'>
            </div>
            ",
            $this->filters['id']
        );
        printf(
            ...
            <input type=text size=20 name=name_filter value='%s'>
            </div>
            ",
            $this->filters['name']
        );
    ...
    function showRecord($carrier)
    {
        ...
        foreach (array_keys($this->Fields) as $item) {
            ...
            if ($this->Fields[$item]['readonly']) {
                ...
                printf(
                    "<div class=controls><input class=span2 name=%s_form type=text value='%s'></div>",
                    $item,
                    $carrier->$item
                );
            }
        ...
        printf("<input type=hidden name=id_filter value='%s'>", $carrier->id);
